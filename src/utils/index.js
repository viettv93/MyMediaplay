export const images = {
    background: require('../image/imageBackground.jpg'),
    previous: require('../image/previousIcon.png'),
    play: require('../image/playIcon.jpg'),
    pause: require('../image/pauseIcon.png'),
    stop: require('../image/stopIcon.png'),
    next: require('../image/nextIcon.png')
}
